                                        ...
                                        <div>
                                            <div>
                                                <p style=" margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; font-family: Imprima, Arial, sans-serif; line-height: 27px; color: #2d3142; font-size: 18px;">
                                                    Your mentor, {{ $details['mentorName'] }}, has assigned homework to you. Please log in to your panel to check the details and complete the homework by the deadline.
                                                </p>
                                            </div>
                                            <br>
