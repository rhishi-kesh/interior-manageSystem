              ...
              <table cellpadding="0" cellspacing="0" class="es-content" align="center">
                <tr>
                  <td align="center" style="padding: 0; margin: 0">
                    <table bgcolor="#efefef" class="es-content-body" align="center" style=" border-collapse: collapse; border-spacing: 0px; background-color: #efefef; border-radius: 20px 20px 0 0; width: auto;">
                      <tr>
                        <td align="left" style="padding: 0; margin: 0; padding:20px;">
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa">
                                  <tr>
                                    <td align="left" style="padding: 10px; margin: 0">
                                        <h3 style=" margin: 0; line-height: 34px; font-family: Imprima, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; color: #2d3142; padding-button: 10px;">
                                            <span style="font-weight: 200;"><b>Dear {{ $recipient->name }},</b></span>
                                        </h3>
                                        <br>
                                        <div>
                                            <div>
                                                <p style=" margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; font-family: Imprima, Arial, sans-serif; line-height: 27px; color: #2d3142; font-size: 18px;">
                                                    This birthday, I wish you abundant happiness and love. May all your dreams turn into reality and may lady luck visit your home today. Happy birthday to one of the sweetest people I've ever known. <br> <br>
                                                    Dear {{ $recipient->name }}, you're getting a 50% discount if you enroll in any other course today. This offer is valid for only 24 hours.
                                                </p>
                                            </div>
                                            <br>
