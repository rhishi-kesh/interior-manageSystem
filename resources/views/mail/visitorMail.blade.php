                                  ...
                                  <tr>
                                    <td align="left" style="padding: 10px; margin: 0">
                                        <h3 style=" margin: 0; line-height: 34px; font-family: Imprima, Arial, sans-serif; font-size: 18px; font-style: normal; font-weight: bold; color: #2d3142; padding-button: 10px;">
                                            <span style="font-weight: 200;"><b>Dear {{ $details['name'] }},</b></span>
                                        </h3>
                                        <br>
                                        <div>
                                            <div>
                                                <p style=" margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; font-family: Imprima, Arial, sans-serif; line-height: 27px; color: #2d3142; font-size: 18px;">
                                                    Thank you so much for visiting us. You can get more information about our courses here: <a href="https://rayhansict.com/our-courses">https://rayhansict.com/our-courses</a>. You can also join our upcoming free seminar/masterclass here: <a href="https://rayhansict.com/seminar">https://rayhansict.com/seminar</a>. Additionally, you can check our reviews here: <a href="https://rayhansict.com/our-success">https://rayhansict.com/our-success</a>.
                                                </p>
                                            </div>
                                            <br>
                                            <div style="display:block;color:black">
                                                ...
                                                <br>
                                                <p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; font-family: Imprima, Arial, sans-serif; line-height: 27px; color: #2d3142; font-size: 18px;">
                                                    Sales Executive Interior Bangladesh
                                                </p>
                                            </div>
                                        </div>
                                    </td>
