    ...
    <form wire:submit="submit" class="bg-white dark:bg-slate-900 shadow-md rounded px-4 md:px-8 pt-6 pb-8 mb-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3">
            ...
            <div class="mb-1">
                ...
                <select name="calling_person" wire:model="calling_person" id="calling_person" class="my-input focus:outline-none focus:shadow-outline">
                    <option value="">Select Calling Person</option>
                    @foreach ($councilings as $item)
